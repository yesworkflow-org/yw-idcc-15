...
\begin{abstract}
  ...
  renderings of this workflow-like view of the scripts.  Future
  versions of \YW\ will allow both the prospective and retrospective
  provenance of the data products of these scripts to be queried in
  ways similar to those available to users of workflow systems that
  record runtime data provenance.
\end{abstract}
...
\item \yw\ annotations and the underlying model are deliberately kept
  ...
  % (below we mention real-world examples that were
  % annotated by scientists with very little effort),
...
\bibliography{yw-idcc15-preprint}
\end{document}
