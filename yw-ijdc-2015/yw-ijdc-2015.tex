...
\author{Kyle Bocinsky\textsuperscript{6}}
...
\revised{ *** TBD ***  February/March 2015}
...
Information Science (GSLIS), University of Illinois at Urbana-Champaign (UIUC);
\textsuperscript{2}Dept.\ of Computer Science, University of California, Davis;
\textsuperscript{3}University of Calgary;
...
\yw\ is also related to ideas from literate programming\footnote{Don
  Knuth has argued \citeNP{knuth1984literate} that we should change our
